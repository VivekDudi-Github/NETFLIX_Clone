  ...
  return (
    <>
      <div className='relative h-screen text-white '>
        ...
        <img className='absolute top-0 left-0 -z-50 object-cover h-full w-full shimmer ' src={ORIGINAL_IMG_BASE_URL+trendingContent.backdrop_path} onLoad={() => setIsImageLoading(false)} />
        <div className=' bg-black/20 h-full w-full absolute top-0 left-0 '/>
        
        <div className=' h-full w-full flex flex-col md:justify-center justify-end px-8 md:px-16 lg:px-32  absolute top-0 left-0 duration-200'>
